...
class Listing extends Configurable
{
    ...
    static public function parse()
    {
        ...
        foreach ($directory as $fileInfo) {
            ...
            if (strpos($fileInfo->getFilename(), '.') === 0 && !static::$settings['show_hidden']) {
                continue;
            }
            if ($fileInfo->getRealPath() === static::$settings['settings_file']) {
                continue;
            }
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="%s">', Translation::getCanonicalLocale());
    ...
    static protected function getFooter()
    {
        ...
        $footer .= '<tr><td colspan="4" class="footer">Powered by <a href="https://github.com/Chansig/DirectoryIndex">Chansig/DirectoryIndex</a></td></tr>' . "\n";
...
class Main
{
    ...
    static protected $setting_file = '.settings.php';
    ...
    {
        spl_autoload_register(array('Chansig\\DirectoryIndex\\Main', 'autoload'));
    ...
    {
        if ($className === 'Chansig\DirectoryIndex\Settings' && !class_exists('Chansig\\DirectoryIndex\\Settings')) {
            $settingsFile = __DIR__ . '/' . static::$setting_file;
